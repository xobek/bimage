...
def parse_args():
    ...
    ap.add_argument("-a", "--amount", help="Amount of images to download", type=int, required=True)
    ap.add_argument("-f", "--folderpath", help="Folder to place all images into", type=str)
    ap.add_argument("-r", "--resolution", help="Specify a resolution to refit all images to (e.g.: -r 128)", type=str)
